          ...
          <div className="p-5">
            <ResponsiveContainer width="100%" height={320}>
              <AreaChart data={chartData} margin={{ top: 10, right: 10, left: 10, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="revenue" name={t('Revenue')} stroke="#0d9488" strokeWidth={2.5} fill="url(#gradRevenue)" dot={false} activeDot={{ r: 5 }} />
                <Area type="monotone" dataKey="totalExpenses" name={t('Total Expenses')} stroke="#ef4444" strokeWidth={2} fill="url(#gradExpenses)" dot={false} activeDot={{ r: 4 }} />
                <Area type="monotone" dataKey="netProfit" name={t('Net Profit')} stroke="#059669" strokeWidth={2.5} fill="url(#gradNetProfit)" dot={false} activeDot={{ r: 5 }} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
                ...
                <div className="flex-1 space-y-2">
                  {revenueData.map((item, i) => (
                    <div key={item.name} className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-600 flex-1 truncate">{t(item.name)}</span>
