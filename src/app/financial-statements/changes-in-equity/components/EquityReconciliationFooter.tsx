      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-5">
        ...
        <div className="flex flex-col gap-2 lg:border-l lg:border-border lg:pl-5">
          <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[var(--positive-bg)] border border-[var(--positive-light)]">
            ...
            <div>
              <div className="text-[12px] font-bold text-foreground">{t('Balanced ✓')}</div>
              <div className="text-[10px] text-muted-foreground">{t('All equity movements reconcile to closing balance')}</div>
            </div>
          </div>
          <div className="flex items-center gap-2.5 p-3 rounded-xl bg-primary/5 border border-primary/15">
            ...
            <div>
              <div className="text-[11px] font-semibold text-foreground">{t('PSAK Compliant')}</div>
              <div className="text-[10px] text-muted-foreground">{t('Indonesian Financial Accounting Standards')}</div>
            </div>
          </div>
        </div>
      </div>
