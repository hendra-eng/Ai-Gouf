...
// Backend integration point: replace with API call to /api/liabilities/charts?period=...
...
export default function LiabilitiesChartsSection() {
      ...
      <div className="xl:col-span-2 fin-card p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <div className="text-[11px] text-muted-foreground">Monthly liability values — PT Nusantara Teknologi Indonesia</div>
          </div>
