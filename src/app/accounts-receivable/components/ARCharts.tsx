    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 2xl:grid-cols-3 gap-4">
      ...
      <div className="xl:col-span-2 bg-card border border-border rounded-lg p-5 shadow-card">
        <div className="flex items-start justify-between mb-4">
          ...
          <span className="text-xs text-danger font-medium bg-danger-bg px-2 py-1 rounded-full">{fx('Rp 320M')} overdue</span>
        </div>
      ...
      <div className="bg-card border border-border rounded-lg p-5 shadow-card">
        ...
        <div className="flex items-center justify-between text-xs mt-1">
          ...
          <span className="font-semibold text-warning">42 days</span>
        </div>
        <div className="flex items-center justify-between text-xs mt-1">
          <span className="text-muted-foreground">Variance</span>
          <span className="font-semibold text-danger">+7 days over target</span>
        </div>
      </div>
    </div>
  );
