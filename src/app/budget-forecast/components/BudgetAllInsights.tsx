...
const INSIGHTS = [
  {
    ...
    numbers: ['YTD Budget Achievement: 94.8%', 'Forecast FY Revenue: Rp 10.48B (+2.7% vs Budget)', 'Q4 Pipeline: Rp 1.92B'],
  ...
  },
  {
    ...
    numbers: ['Budget EBITDA: Rp 2.55B', 'Forecast EBITDA: Rp 2.72B', 'Upside: +Rp 170M (+6.7%)'],
  ...
  },
  {
    ...
    summary: 'Cash position remains strong at Rp 2.96B. Forecast ending cash of Rp 3.84B indicates healthy liquidity through FY2026.',
    numbers: ['Current Cash: Rp 2.96B', 'Forecast Ending Cash: Rp 3.84B', 'Minimum Threshold: Rp 1.50B'],
