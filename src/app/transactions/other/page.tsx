...
export default function OtherTransactionsPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return data;
  }, [otherTx, search, statusFilter, sortKey, sortDir]);
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-3xl font-700 text-foreground">Other</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-6">
        <KpiCard title="Total Other" value={totalOther} icon="Squares2X2Icon" iconColor="text-slate-600" iconBg="bg-slate-100" compact />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <div className="lg:col-span-2 bg-card border-2 border-border rounded-lg shadow-card-md card-hover p-5">
          <div className="mb-4">
            <h2 className="text-sm font-bold text-text-primary">Tren Other Bulanan</h2>
            <p className="text-xs text-text-secondary mt-0.5">Berdasarkan transaksi yang tercatat di halaman Transaksi</p>
          </div>
          {trend.length === 0 ? (
            <p className="text-xs text-text-secondary py-10 text-center">Belum ada transaksi Other untuk ditampilkan.</p>
          ) : (
        ...
        <div className="bg-card border-2 border-border rounded-lg shadow-card-md card-hover p-5">
          <h2 className="text-sm font-bold text-text-primary mb-1">Other per Kategori</h2>
          <p className="text-xs text-text-secondary mb-3">Breakdown transaksi lain-lain</p>
          {byCategory.length === 0 ? (
      ...
      <div className="bg-card border-2 border-border rounded-lg shadow-card-md card-hover p-5 mb-6">
        <h2 className="text-sm font-bold text-text-primary mb-1">Top Pihak Terkait</h2>
      ...
      <div className="bg-card border-2 border-border rounded-lg shadow-card-md">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-5 py-4 border-b border-border">
          <div>
            <h2 className="text-sm font-bold text-text-primary">Transaksi Other</h2>
        ...
        <DataTable
          ...
          sortDir={sortDir}
          onSort={handleSort}
          emptyMessage="Belum ada transaksi lain-lain. Tambahkan / import di halaman Transaksi."
        />
